...
class ThirdFragment : Fragment() {
    ...
    fun changeQuestion(){
        ...
        Log.i("Third", currentQuestion.toString())
    ...
    fun setImages(){
        ...
        if (questionID == 0){ questionImage.setImageResource(R.drawable.p2q1) }
        if (questionID == 1){ questionImage.setImageResource(R.drawable.p2q2) }
        if (questionID == 2){ questionImage.setImageResource(R.drawable.p2q3) }
        if (questionID == 3){ questionImage.setImageResource(R.drawable.p2q4) }
        if (questionID == 4){ questionImage.setImageResource(R.drawable.p2q5) }
        if (questionID == 5){ questionImage.setImageResource(R.drawable.p2q6) }


        for(nums in 0..2){
            answerImages[nums].setImageResource(R.drawable.lego_computer)//Test

            if (answers[nums] == 0){ answerImages[nums].setImageResource(R.drawable.p2a1) }
            if (answers[nums] == 1){ answerImages[nums].setImageResource(R.drawable.p2a2) }
            if (answers[nums] == 2){ answerImages[nums].setImageResource(R.drawable.p2a3) }
            if (answers[nums] == 3){ answerImages[nums].setImageResource(R.drawable.p2a4) }
            if (answers[nums] == 4){ answerImages[nums].setImageResource(R.drawable.p2a5) }
            if (answers[nums] == 5){ answerImages[nums].setImageResource(R.drawable.p2a6) }
        }
